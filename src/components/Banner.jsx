...
const Banner = () => {
    const BG = 'https://i.ibb.co/x6yH4xW/rsz-1eugenivy-now-1-bs2s-z9f-d2-q-unsplash.jpg';
    useEffect(() => {
        AOS.init({
            delay: 200,
            offset: 300,
    ...
    return (<>
        <section className="min-h-screen flex items-center justify-center bg-cover bg-center bg-black bg-opacity-50" style={{ backgroundImage: `url(${BG})` }}>
            <div className="min-h-screen w-full flex items-center justify-center bg-cover bg-center bg-black bg-opacity-50">
